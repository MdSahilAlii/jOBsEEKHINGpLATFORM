...
const TableGroupDividers = () => {
  return <Card>
            <CardHeader className="justify-content-between">
                ...
                <Link to="https://getbootstrap.com/docs/5.3/content/tables/#table-group-dividers" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
            ...
            <CardBody>
                <p className="text-muted">
                    ...
                    groups—<code>&lt;thead&gt;</code>, <code>&lt;tbody&gt;</code>, and <code>&lt;tfoot&gt;</code>
                    —with <code>.table-group-divider</code>. Customize the color by changing
                    the <code>border-top-color</code> (which we don’t currently provide
