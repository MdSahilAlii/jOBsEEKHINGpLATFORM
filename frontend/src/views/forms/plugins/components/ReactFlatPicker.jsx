...
const ReactFlatPicker = () => {
  return <Card>
            ...
            <CardBody>
                ...
                <Link className="p-0 fw-semibold" to="https://github.com/haoxins/react-flatpickr" target="_blank">
                    React Flatpickr
            ...
            defaultDate: 'today'
                ...
                <Row className="g-4">
                    ...
                    <Col lg={6}>
                        <Flatpickr className="form-control" placeholder="Select Date" options={{
            dateFormat: 'd M, Y',
            minDate: '25 12, 2021',
            maxDate: '29 12,2021'
          }} />
            ...
            <CardBody>
                ...
                <Row className="g-4">
                    ...
                    <Col lg={6}>
                        <Flatpickr className="form-control" placeholder="Select Time" options={{
            enableTime: true,
            noCalendar: true,
            dateFormat: 'H:i'
          }} />
