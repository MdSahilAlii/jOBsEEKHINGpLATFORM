...
const columns = [{
  ...
  data: 'extn',
  render: function (data, type) {
    return type === 'display' ? `<div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="${data}" aria-valuemin="0" aria-valuemax="9999" style="height:8px">
