...
const Header = ({
  ...
  return <>
            {withProgress && <ProgressBar now={(activeStep + 1) * (100 / stepCount)} className="mb-3" style={{
      height: '6px'
    }} />}
            ...
            <Row>
                ...
                <Col xl={6}>
                    <FormGroup className="mb-3">
                        ...
                        <Flatpickr className="form-control" placeholder="Select you DOB" options={{
            dateFormat: 'd M, Y'
          }} name="dob" required />
                    </FormGroup>
                </Col>
...
const Page = () => {
  return <Container fluid>
            <PageTitle title="Form Wizard" subtitle="Guide users through multi-step forms with clear navigation and progress tracking for improved user experience." badge={{
            ...
            <Row>
                <Col cols={12}>
                    ...
                    <ComponentCard title="Vertical Wizard">
                        <div className="row">
                            <Wizard header={<div className="col-md-4">
