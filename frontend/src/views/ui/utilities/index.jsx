...
const ColorAndBackground = () => {
  return <ComponentCard title="Color & Background" isCollapsible>
            <p className="text-muted">
                ...
                <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our
                Sass <code>color-contrast()</code> function, we
...
const BackgroundOpacity = () => {
  return <ComponentCard title="Background Opacity" isCollapsible>
            <p className="text-muted">
                ...
                real-time color changes without
...
const TextOpacityColor = () => {
  return <ComponentCard title="Text Opacity Color" isCollapsible>
            <p className="text-muted">
                ...
                changes without compilation and dynamic
...
const BorderRadius = () => {
  return <ComponentCard title="Border Radius" isCollapsible>
            ...
            <div className="d-flex align-items-start flex-wrap gap-2">
                <img src={user2} className="avatar-lg rounded" alt="rounded" />
                <img src={user2} className="avatar-lg rounded-top" alt="rounded-top" />
                <img src={user2} className="avatar-lg rounded-end" alt="rounded-end" />
                <img src={user2} className="avatar-lg rounded-bottom" alt="rounded-bottom" />
                <img src={user2} className="avatar-lg rounded-start" alt="rounded-start" />
                <img src={user2} className="avatar-lg rounded-circle" alt="rounded-circle" />
                <img src={small3} className="w-auto rounded-pill" alt="rounded-pill" width={80} />
            </div>
        </ComponentCard>;
};
const PointerEvents = () => {
  return <ComponentCard title="Pointer Events" isCollapsible>
            ...
            <p>
                <Link to="#" className="pe-none" tabIndex={-1}>
                    This link
                </Link>
                can not be clicked.
            </p>
...
const BorderRadiusSize = () => {
  return <ComponentCard title="Border Radius Siz" isCollapsible>
            ...
            <div className="d-flex align-items-start flex-wrap gap-2">
                <img src={user4} className="avatar-lg rounded-0" alt="rounded-0" />
                <img src={user4} className="avatar-lg rounded-1" alt="rounded-1" />
                <img src={user4} className="avatar-lg rounded-2" alt="rounded-2" />
                <img src={user4} className="avatar-lg rounded-3" alt="rounded-3" />
                <img src={user4} className="avatar-lg rounded-4" alt="rounded-4" />
                <img src={user4} className="avatar-lg rounded-5" alt="rounded-5" />
            </div>
        </ComponentCard>;
};
const TextSelection = () => {
...
const Overflow = () => {
  return <ComponentCard title="Overflow" isCollapsible>
            <p className="text-muted">
                Adjust the <code>overflow</code> property on the fly with four default values and classes. These classes
                are not responsive by default.
            </p>
        ...
        maxHeight: 100
                    ...
                    add more text dimensions simple admin
                    dashboard template.
                </div>
...
const Width = () => {
  return <ComponentCard title="Width" isCollapsible>
            <p className="text-muted">
                ...
                default sizes (which have associated
                variables to match).
            </p>
...
const ObjectFit = () => {
  return <ComponentCard title="Object Fit" isCollapsible>
            <p className="text-muted">
                ...
                <Link to="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit" target="_blank">
                    <code>object-fit</code>
                    property
                </Link>
                with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the
                parent container in a variety of
...
const Zindex = () => {
  return <ComponentCard title="Z-index" isCollapsible>
            <p className="text-muted">
                Use <code>z-index</code> utilities to stack elements on top of one another. Requires
                a <code>position</code> value other than
                <code>static</code>, which can be set with custom styles or using our
                <Link to="https://getbootstrap.com/docs/5.3/utilities/position/" target="_blank">
                    position utilities
                </Link>
                .
            </p>
