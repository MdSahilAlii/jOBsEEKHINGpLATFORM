...
const StripedRowTable = () => {
  return <Card>
            <CardHeader className="justify-content-between">
                ...
                <Link to="https://react-bootstrap.netlify.app/docs/components/table#striped-rows" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
                    View Docs <TbArrowRight className="bi align-middle fs-lg"></TbArrowRight>
                </Link>
            </CardHeader>

            <CardBody>
                <Table responsive striped className="align-middle mb-0">
