...
const HoverableRowsTable = () => {
  return <Card>
            <CardHeader className="justify-content-between">
                ...
                <Link to="https://react-bootstrap.netlify.app/docs/components/table#example" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
