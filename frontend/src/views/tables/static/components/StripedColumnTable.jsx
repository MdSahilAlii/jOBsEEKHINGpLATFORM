...
const StripedColumnTable = () => {
  return <Card>
            <CardHeader className="justify-content-between">
                <CardTitle> Striped Columns </CardTitle>
                <Link to="https://react-bootstrap.netlify.app/docs/components/table#striped-columns" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
                    View Docs <TbArrowRight className="bi align-middle fs-lg" />
                </Link>
            </CardHeader>

            <CardBody>
                <Table responsive striped="columns" className="align-middle mb-0">
